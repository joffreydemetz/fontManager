...
try {
    ...
    check($fontsDb, 'Roboto/regular', null, null, $subsets);
    check($fontsDb, 'Roboto', 800, null, $subsets);
    check($fontsDb, 'Roboto', '600', 'italic', $subsets);
    check($fontsDb, 'Lato/regular', null, null, $subsets);
    check($fontsDb, 'Lato/italic', null, null, $subsets);
    check($fontsDb, 'montserrat/light', null, null, $subsets);
    check($fontsDb, 'Montserrat/700italic', null, null, $subsets);
    ...
    install($fontsDb, 'Roboto', null, null, $subsets);
    install($fontsDb, 'Roboto', '550', 'italic', $subsets);
    install($fontsDb, 'Montserrat/700italic', null, null, $subsets);
    ...
    get($fontsDb, 'Montserrat/550italic', null, null, $subsets);
